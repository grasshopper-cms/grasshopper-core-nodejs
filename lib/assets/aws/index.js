module.exports = (function(){
    ...
    internal.constructUrl = function(fileName){
        return url.resolve(url.resolve(internal.config.urlbase, internal.config.bucket), fileName);
    };
    ...
    internal.getObject = function(nodeid, filename) {
        ...
        this.s3.getObject({Bucket: internal.config.bucket, Key: nodeid + '/' + filename}, function(err, data) {
            if (err) {
