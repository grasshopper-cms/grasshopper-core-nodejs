module.exports = (function(){
    ...
    engine.query = function(params){
        ...
        getNodes(params.nodes)
        .then(function(nodes){
            _.each(nodes, function(node){
                console.log(path.join(internal.config.path, node));
            });
        });
        ...
        function getNodes(nodes){
            ...
            if(_.isArray(nodes) && !_.isEmpty(nodes)){
                ...
                FS.listTree(internal.config.path, function(path, stat){
                    if (!_.isEqual(path, internal.config.path)){
