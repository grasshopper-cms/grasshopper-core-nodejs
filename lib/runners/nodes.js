module.exports = (function() {
    ...
    coordinator.batch(
        ...
        ['getById', 'getChildren'],[
            ...
            middleware.nodes.permissionsMap,
    ...
    return function users(kontx){
        return {
            ...
            getById: function(id, includeChildren, deep){
                return coordinator.handle('nodes.getById',  {id: id, includeChildren: includeChildren, deep: deep}, kontx);
            },
