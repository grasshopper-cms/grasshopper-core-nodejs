    ...
    return function users(kontx){
        return {
            ...
            linkIdentity: function(userId, key, options){
                return coordinator.handle('users.linkIdentity', [userId, key, options], kontx);
            },
            unLinkIdentity: function(userId, key) {
                return coordinator.handle('users.unLinkIdentity', [userId, key], kontx);
            }
        };
    };
})();