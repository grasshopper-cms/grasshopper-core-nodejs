module.exports = (function(){
    ...
    node.getById = function(id) {
        ...
        //Do a little checking to see if a object was sent in or a string
        if(_.isObject(id) && !_.isUndefined(id.id)){
            //Only override the id if it is a valid objectid format
    ...
    node.getByParent = function(id){
        ...
        this.model.find({parent: id}, this.buildIncludes())
            .populate('allowedTypes parent ancestors', '_id label')
            .lean()
            .exec(function(err, doc){
                handleNode(err, doc, deferred);
