module.exports = (function(){
    ...
    var _updateSiblingsAncestors = function (item, oldAncestors, newAncestors, next) {
                            ...
                            if (op === "move") {
                                if (destination !== "0") {
                                    ...
                                    if (intersection.length || _.contains(nodeInputIds, destination.id)) {
                                        ...
                                        _moveContent(destination._id, dataContentEntries, dataNodeEntries, deferred);
                                    }
                                ...
                                _copyContent(destination._id, dataContentEntries, dataNodeEntries, deferred);
                            }
                            else {
