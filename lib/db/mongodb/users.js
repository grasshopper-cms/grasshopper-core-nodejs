module.exports = (function(){
    ...
    user = Object.create(crud, {
        ...
        privateFields: {value: ['salt', 'pass_hash','identities']}
    });
    ...
    user.basicAuthentication = function(username, password){
        ...
        this.model.findOne({'identities.basic.username': username}, function(err, doc){
    ...
    user.update = function(obj){
        ...
        this.model.findById(primaryKey, function(err, doc) {
            ...
            if(doc) {
                mergedObj = _.merge({ identities: existingIdentities }, obj);
