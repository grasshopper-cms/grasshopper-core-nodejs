...
module.exports = function(){
        ...
        let Crud = {
            ...
            /**
             * @param id
             * @param options - Options to be passed to mongoose
             * @param destination - Collection name to target
             */
            getById: function(id, options, destination) {
                var deferred = q.defer();

                this.model(destination).findById(id, this.buildIncludes(options)).lean().exec(function(err, doc){
                    if(err) {
                        deferred.reject(createError(err));
                    }
                    else if (doc !== null) {
