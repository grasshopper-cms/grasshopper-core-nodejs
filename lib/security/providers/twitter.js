...
var _ = require('lodash'),
    ...
    appId = config.identities.twitter.appId,
    secret = config.identities.twitter.secret,
    scopes = config.identities.twitter.scopes,
    redirectUrl = config.identities.twitter.redirectUrl,
...
module.exports = {
    auth: function(options) {
        var oath = new OAuth(
                    ...
                    appId, secret, '1.0', null, 'HMAC-SHA1');

        return BB.bind({ creds: null, socialUserInfo: null, userInfo: null, options:options, oauth: oauth })
