...
var _ = require('lodash'),
    ...
    instagram = new Purest({promise: true, provider:'instagram', key: config.identities.instagram.key, secret: config.identities.instagram.secret}),
...
function _createUser(){
    var excludedFields = ['name', 'screen_name', 'profile_image'],
        ...
        enabled: true,
        email: 'instagram-' + this.options.user.id,
